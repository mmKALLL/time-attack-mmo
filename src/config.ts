...
export const MAP_CONFIG: Record<Biome, MapConfig> = {
  town: {
    width: 15,
    height: 12,
    gen: { roomCount: 1, roomMin: 5, roomMax: 8, roomShape: 'rectangular', corridorWidth: 2, torchDensity: 4, obstacleCount: 2, npcCount: 4 },
  ...
  forest: {
    width: 20,
    height: 15,
    gen: { roomCount: 2, roomMin: 5, roomMax: 8, roomShape: 'natural', corridorWidth: 2, torchDensity: 3, obstacleCount: 4, npcCount: 0 },
  ...
  lake: {
    width: 22,
    height: 17,
    gen: { roomCount: 3, roomMin: 5, roomMax: 8, roomShape: 'natural', corridorWidth: 2, torchDensity: 3, obstacleCount: 7, npcCount: 0 },
...
export const COMBAT_TICK_MS = 2000; // default per-skill trigger interval (6 * STEP_MS)
