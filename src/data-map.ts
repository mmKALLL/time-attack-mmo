...
function town(id: string, name: string, description: string, npcCount = MAP_CONFIG.town.gen.npcCount): MapDef {
  ...
  return {
    ...
    gen: {
      ...
      height: cfg.height,
      tileset: 'town',
      roomCountMin: cfg.gen.roomCount,
      roomCountMax: cfg.gen.roomCount,
      roomShape: cfg.gen.roomShape,
      corridorWidth: cfg.gen.corridorWidth,
      roomMin: cfg.gen.roomMin,
      roomMax: cfg.gen.roomMax,
      torchDensity: cfg.gen.torchDensity,
      obstacleCount: cfg.gen.obstacleCount,
      npcCount,
    },
    connections: [],
