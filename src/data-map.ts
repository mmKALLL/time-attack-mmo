...
export const MAPS: Record<string, MapDef> = {
  farmland: {
    ...
    gen: { width: W, height: H, tileset: 'town', roomCountMin: 2, roomCountMax: 3, roomShape: 'rectangular', corridorWidth: 2, roomMin: 5, roomMax: 8, torchDensity: 3, obstacleCount: 3 },
  ...
  plains: {
    ...
    gen: { width: W, height: H, tileset: 'forest', roomCountMin: 2, roomCountMax: 3, roomShape: 'natural', corridorWidth: 2, roomMin: 6, roomMax: 9, torchDensity: 2, obstacleCount: 3 },
  ...
  forest: {
    ...
    gen: { width: W, height: H, tileset: 'forest', roomCountMin: 3, roomCountMax: 4, roomShape: 'natural', corridorWidth: 1, roomMin: 4, roomMax: 6, torchDensity: 3, obstacleCount: 5 },
  ...
  mistyForest: {
    ...
    gen: { width: W, height: H, tileset: 'deepForest', roomCountMin: 3, roomCountMax: 4, roomShape: 'natural', corridorWidth: 1, roomMin: 4, roomMax: 6, torchDensity: 3, obstacleCount: 5 },
  ...
  deepDungeon: {
    ...
    gen: { width: W, height: H, tileset: 'town', roomCountMin: 3, roomCountMax: 4, roomShape: 'rectangular', corridorWidth: 1, roomMin: 4, roomMax: 6, torchDensity: 8, obstacleCount: 4 },
